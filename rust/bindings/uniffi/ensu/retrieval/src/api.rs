...
impl From<core::Passage> for Passage {
...
impl RetrievalIndex {
    ...
    /// L2-normalized embedding from `inference_rs::embed`. Empty result => the
    /// gate rejected everything (caller injects no retrieved context).
    pub fn search(
        &self,
        query: Vec<f32>,
        k: u32,
